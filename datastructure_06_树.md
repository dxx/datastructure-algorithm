...
> 各种语言实现代码：[Go](./golang/datastructure/tree)   [Java](java/datastructure/src/com/dxx/tree)   [JavaScript](javascript/datastructure/tree)   [Python](./python/datastructure/tree)   [Rust](./rust/datastructure/src/tree)
>
> 默认使用 **Go** 语言实现。
