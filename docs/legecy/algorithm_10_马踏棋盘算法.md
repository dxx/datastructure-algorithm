...
>各种语言实现代码：[Go](../../code/golang/algorithm/horsetreads)   [Java](../../code/java/algorithm/src/com/dxx/horsetreads)   [JavaScript](../../code/javascript/algorithm/horsetreads)   [TypeScript](../../code/typescript/algorithm/horsetreads)   [Python](../../code/python/algorithm/horse_treads)   [Rust](../../code/rust/algorithm/src/horse_treads)
>
>默认使用 **Go** 语言实现。
