...
>各种语言实现代码：[Go](./golang/algorithm/divide)   [Java](./java/algorithm/src/com/dxx/divide)   [JavaScript](./javascript/algorithm/divide)   [TypeScript](./typescript/algorithm/divide)   [Python](./python/algorithm/divide)   [Rust](./rust/algorithm/src/divide)
>
>默认使用 **Python** 语言实现。
