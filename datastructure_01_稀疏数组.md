...
> 各种语言实现代码：[Go](./golang/datastructure/sparsearray)   [Java](./java/datastructure/src/com/mcx/sparsearray)   [JavaScript](./javascript/datastructure/sparsearray)   [Rust](./rust/datastructure/src/sparsearray)
>
> 默认使用 **Go** 语言实现。
