...
>各种语言实现代码：[Go](./golang/algorithm/kruskal)   [Java](java/algorithm/src/com/dxx/kruskal)   [JavaScript](javascript/algorithm/kruskal)   [Python](./python/algorithm/kruskal)   [Rust](./rust/algorithm/src/kruskal)
>
>默认使用 **Go** 语言实现。
