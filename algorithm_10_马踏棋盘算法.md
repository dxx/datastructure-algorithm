...
>各种语言实现代码：[Go](./golang/algorithm/horsetreads)   [Java](./java/algorithm/src/com/dxx/horsetreads)   [JavaScript](./javascript/algorithm/horsetreads)   [Python](./python/algorithm/horsetreads)   [Rust](./rust/algorithm/src/horse_treads)
>
>默认使用 **Go** 语言实现。
