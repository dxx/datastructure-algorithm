...
> 各种语言实现代码：[Go](./golang/datastructure/linkedlist)   [Java](./java/datastructure/src/com/dxx/linkedlist)   [JavaScript](./javascript/datastructure/linkedlist)   [Python](./python/datastructure/linkedlist)   [Rust](./rust/datastructure/src/linked_list)
>
> 默认使用 **Go** 语言实现。
