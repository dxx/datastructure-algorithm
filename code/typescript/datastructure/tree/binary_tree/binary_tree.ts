 ...
 * 前序遍历 
 */
function preOrder(node: BinaryTreeNode | null) {
  if (!node) {
    return;
  }
  // 当前节点
 ...
 * 中序遍历 
 */
function infixOrder(node: BinaryTreeNode | null) {
  if (!node) {
    return;
  }
  // 遍历左子树
 ...
 * 后序遍历 
 */
function postOrder(node: BinaryTreeNode | null) {
  if (!node) {
    return;
  }
  // 遍历左子树
 ...
 * 前序查找 
 */
function preOrderSearch(node: BinaryTreeNode | null, no: number): BinaryTreeNode | null {
  if (!node) {
    return null;
  }
  console.log("进入查找");
 ...
 * 中序查找 
 */
function infixOrderSearch(node: BinaryTreeNode | null, no: number): BinaryTreeNode | null {
  if (!node) {
    return null;
  }
  // 左边查找
 ...
 * 后序查找
 */
function postOrderSearch(node: BinaryTreeNode | null, no: number): BinaryTreeNode | null {
  if (!node) {
    return null;
  }
  // 左边查找
