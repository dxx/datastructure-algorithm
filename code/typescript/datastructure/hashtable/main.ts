...
class LinkNode {
  ...
  constructor(employee: Employee, next: LinkNode | null) {
 ...
 */
class Hashtable {
  private linkArray: Array<LinkNode | null>;

  constructor(len: number) {
    this.linkArray = new Array(len).fill(null);
  }
  ...
  getEmployeeById(id: number) {
    ...
    // 查找链表中是否存在相同 id 的员工
    let tempNode: LinkNode | null = headNode;
    while (tempNode != null) {
