...
>各种语言实现代码：[Go](./golang/algorithm/stringmatch)   [Java](./java/algorithm/src/com/dxx/stringmatch)   [JavaScript](./javascript/algorithm/stringmatch)   [Python](./python/algorithm/stringmatch)   [Rust](./rust/algorithm/src/string_match)
>
>默认使用 **Go** 语言实现。
