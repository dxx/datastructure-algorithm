...
> 各种语言实现代码：[Go](./golang/algorithm/sort)   [Java](./java/algorithm/src/com/dxx/sort)   [JavaScript](./javascript/algorithm/sort)   [Python](./python/algorithm/sort)   [Rust](./rust/algorithm/src/sort)
>
> 默认使用 **Go** 语言实现。
